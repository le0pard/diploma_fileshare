LessJsRoutes = {
  ...
  // bulk_action_admin_uploaded_files => /admin/uploaded_files/bulk_action(.:format)
  bulk_action_admin_uploaded_files_path: function(format, verb){ format = LessJsRoutes.less_check_parameter(format); return LessJsRoutes.less_check_path('/admin/uploaded_files/bulk_action.' + format + '');},
  bulk_action_admin_uploaded_files_ajax: function(format, verb, params, options){ format = LessJsRoutes.less_check_parameter(format); return LessJsRoutes.less_ajax(LessJsRoutes.less_check_path('/admin/uploaded_files/bulk_action.' + format + ''), verb, params, options);},
  bulk_action_admin_uploaded_files_ajaxx: function(format, verb, params, options){ format = LessJsRoutes.less_check_parameter(format); return LessJsRoutes.less_ajaxx(LessJsRoutes.less_check_path('/admin/uploaded_files/bulk_action.' + format + ''), verb, params, options);},
